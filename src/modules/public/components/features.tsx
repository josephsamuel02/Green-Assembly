  ...
  return (
    <div className=" max-w-full mt-32 ">
      ...
      <div id="features" className=" max-w-full    flex flex-row flex-wrap items-center">
        <div className=" mx-auto md:my-10 p-1 py-12 w-3/5  md:w-1/5 flex flex-col bg-green-100 rounded-md shadow hover:shadow-lg">
          <img
        ...
        <div className=" mx-auto md:my-10 p-1 py-12 w-3/5  md:w-1/5 flex flex-col bg-green-200 rounded-md shadow hover:shadow-lg">
