...
const Manifesto = (param: { setShowForm: React.Dispatch<React.SetStateAction<boolean>> }) => {
  return (
    <>
      <div className="mx-auto mt-20 mb-32 pt-22 pb-10 md:py-28 w-full h-96 md:h-auto flex flex-row flip-horizontal my-6 px-6 bg-AssemblyPhoto bg-cover bg-no-repeat items-center ">
