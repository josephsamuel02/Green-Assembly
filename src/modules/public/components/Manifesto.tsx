...
const Manifesto = (param: { setShowForm: React.Dispatch<React.SetStateAction<boolean>> }) => {
  return (
    <>
      <div className="mx-auto mt-56 mb-32 pt-22 pb-10 md:pb-28 md:pt-10 w-full h-96 md:h-auto flex flex-row flip-horizontal my-6 px-6 bg-AssemblyPhoto bg-cover bg-no-repeat items-center ">
